...
//    }
    ...
    public void testIncoherentGraph(){
        ...
        nodes = new HashSet<Node>(){{add(node1); add(node2); add(node3); add(node4);}};
        extraDFS = new ExtraDFS(nodes);
        List<TwoCoherentComponent> twoCoherentComponents = extraDFS.findTwoCoherentComponents();
    ...
    public void testTwoPartCompleteGraph(){
        ...
        nodes = new HashSet<Node>(){{add(node1); add(node2); add(node3); add(node4); add(node5);}};
        extraDFS = new ExtraDFS(nodes);
        List<TwoCoherentComponent> twoCoherentComponents = extraDFS.findTwoCoherentComponents();
        assertEquals(1, twoCoherentComponents.size());
    }
...
//        DataSourceFileReader dataSourceFileReader = new DataSourceFileReader(ExtraDFSTest.class.getResource("edges.txt").getPath());
//        nodes = dataSourceFileReader.makeNodesFromFile();
        extraDFS = new ExtraDFS(nodes);
        List<TwoCoherentComponent> twoCoherentComponents = extraDFS.findTwoCoherentComponents();
        assertEquals(5, twoCoherentComponents.size());
    }
//
//    public void testGraph(){
